 ...
 */
final class Version20220321111138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agents CHANGE images_id images_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE products CHANGE agents_id agents_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agents CHANGE images_id images_id INT NOT NULL');
        $this->addSql('ALTER TABLE images DROP photo, CHANGE products_id products_id INT NOT NULL');
        $this->addSql('ALTER TABLE products CHANGE agents_id agents_id INT NOT NULL');
    }
}
